...
### Rick&Morty: Proyecto incubadora React

Rick&Morty 📺 es una sencilla prueba de desarrollo de una aplicación web de búsqueda de personajes favoritos de la serie Rick and Morty. Te permite buscar tu personaje favorito, averiguar todo sobre él y guardarlo en local storage.
...
1. Listado de personajes: con los datos desde https://rickandmortyapi.com/documentation/#get-all-characters, pintar los personajes (foto, nombre y especie).
